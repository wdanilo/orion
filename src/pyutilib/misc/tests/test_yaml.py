...
class TestSimple(unittest.TestCase):
    ...
    def test1(self):
        """Parse yamldata1.yml"""
        self.assertEquals({'a': {'b': 1, 'c': 1.3}, 'd': {'e': 'the rain in spain', 'f': 'is mostly on the plain'}} , pyutilib.misc.simple_yaml_parser(currdir+'yamldata1.yml'))

    def test2(self):
        """Parse yamldata2.yml"""
        self.assertEquals({'a': {'b': 1, 'c': 1.3}, 'd': {'e': 'the rain in spain', 'f': 'is mostly on the plain'}, 'g': 'again'} , pyutilib.misc.simple_yaml_parser(currdir+'yamldata2.yml'))

    def test3(self):
        """Parse yamldata3.yml"""
        self.assertEquals(['a','b','c'], pyutilib.misc.simple_yaml_parser(currdir+'yamldata3.yml'))

    def test5(self):
        """Parse yamldata5.yml"""
        self.assertEquals({'a': ['b', 1, {'c': 'ccc', 'e': 'eee', 'd': 'ddd'}, 1.3], 'g': 'again'}, pyutilib.misc.simple_yaml_parser(currdir+'yamldata5.yml'))

    def test6(self):
        """Parse yamldata6.yml"""
        self.assertEquals({'a': [1, {'c': 'ccc', 'e': 'eee', 'd': 'ddd'}, 1.3], 'g': 'again'}, pyutilib.misc.simple_yaml_parser(currdir+'yamldata6.yml'))

    def test7(self):
        """Parse yamldata7.yml"""
        self.assertEquals({'a': [1, {'c': 'ccc', 'e': 'eee', 'd': 'ddd'}, 1.3, 'x', 'y'], 'g': 'again'}, pyutilib.misc.simple_yaml_parser(currdir+'yamldata7.yml'))

    def test11(self):
        """Parse yamldata11.yml"""
        self.assertEquals(['a', ['b', 'c', ['d', 'e'], 'f', 'g'], 'h'], pyutilib.misc.simple_yaml_parser(currdir+'yamldata11.yml'))

    def test12(self):
        """Parse yamldata12.yml"""
        self.assertEquals(['a', {'X': ['b', ['d', 'e'], 'f', 'g'], 'Y': 'FOO'}, 'h'], pyutilib.misc.simple_yaml_parser(currdir+'yamldata12.yml'))
